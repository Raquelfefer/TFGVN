...
public class PantallaLogin implements Screen {
    ...
    public PantallaLogin(Main game) {
        ...
        // --- CAMBIO CLAVE: Usamos el skin global de Main ---
        this.skin = game.skin; 
    }
    ...
    public void show() {
        ...
        // --- TÍTULO CON FUENTE ZEN LOOP (Dorado) ---
        Label titulo = new Label("El viaje de Laurie", skin, "titulo");
        
        // ELEMENTOS DEL FORMULARIO (Usan Coming Soon por defecto)
        ...
        mensajeEstado.setColor(Color.SCARLET); // Un rojo más dulce
        ...
        table.center();
        table.add(titulo).colspan(2).padBottom(40).center().row(); // Título arriba
    ...
    public void dispose() {
        stage.dispose();
        // IMPORTANTE: NO hacemos skin.dispose() porque lo gestiona Main
    }
}