...
public class PantallaLogros implements Screen {
    ...
    public void show() {
        ...
        // Colores Cozy para los fondos de las listas (Marrón café con transparencia)
        ...
        for (LogroDetalleDTO l : logros) {
            ...
            descLabel.setFontScale(0.85f); // Un poco más grande para Coming Soon
            ...
            if (l.conseguido) {
                ...
                nameLabel.setColor(Color.valueOf("888888")); // Grisáceo para bloqueado
    ...
    @Override public void dispose() {
        stage.dispose();
        // skin.dispose() no es necesario aquí
