...
public class PantallaRegistro implements Screen {
    ...
    public PantallaRegistro(Main game) {
        ...
        // --- LIMPIEZA: Usamos el skin global ---
        this.skin = game.skin; 
    }
    ...
    public void show() {
        ...
        // Reutilizamos el fondo de login o puedes poner uno específico
        ...
        // El SelectBox (Desplegable) ya hereda la fuente Coming Soon del skin global
        ...
        mensajeEstado.setColor(Color.SCARLET); // Color más acorde a la paleta cozy
        ...
        // Etiquetas a la izquierda, campos a la derecha
    ...
    public void dispose() { 
        stage.dispose(); 
        // No disponemos el skin aquí porque es el global de Main
    }
}