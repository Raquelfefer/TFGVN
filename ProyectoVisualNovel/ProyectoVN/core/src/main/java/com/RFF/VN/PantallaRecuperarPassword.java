...
public class PantallaRecuperarPassword implements Screen {
    ...
    public void show() {
        ...
        // Mensaje de instrucción (Usará Coming Soon)
        ...
        etiquetaPregunta.setColor(Color.valueOf("E8E4D8")); // Un crema clarito
        ...
        // Elementos que empiezan ocultos
